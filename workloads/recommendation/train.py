...
parser.add_argument('--checkpoint_dir', type=str,
                    default='/home/ruipan/checkpoints/recommendation',
                    help='Checkpoint dir')
...
train_matrix, item_id_map, _ = dataframe_to_csr_matrix(
    train_df, **common_params)
...
trainer = Recoder(model=model, use_cuda=use_cuda, optimizer_type='adam',
                  ...
                  gavel_dir=(
                      args.checkpoint_dir if args.enable_gavel_iterator else None),
                  apex_amp=args.apex_amp)
