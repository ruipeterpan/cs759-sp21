...
\mlsystitlerunning{Submission and Formatting Instructions for MLSys 2021}

\begin{document}

\twocolumn[
\mlsystitle{Submission and Formatting Instructions for MLSys 2021}
...
Submission to MLSys 2021 will be entirely electronic, via a web site
...
\texttt{nohyperref} as one of the options to the \texttt{mlsys2021}
...
$\mathit{4}^{th}$ MLSys Conference},
San Jose, CA, USA, 2020.
Copyright 2021 by the author(s).''

For those using the \textbf{\LaTeX} style file, this change (and others) is
handled automatically by simply changing
$\mathtt{\backslash usepackage\{mlsys2021\}}$ to
$$\mathtt{\backslash usepackage[accepted]\{mlsys2021\}}$$
...
you are using \LaTeX\/ and the \texttt{mlsys2021.sty} file, use
...
A sample file with author names is included in the mlsys2021 style file
...
facility, use \texttt{natbib.sty} and \texttt{mlsys2021.bst}
